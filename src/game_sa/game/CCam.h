...
public:
	...
	virtual void SetTargetEntity(CEntity* pEntity) const = 0;
	virtual void GetDirection(float& fHorizontal, float& fVertical) const = 0;
	virtual void SetDirection(float fHorizontal, float fVertical) const = 0;
};
