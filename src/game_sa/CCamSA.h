...
public:
	...
	void SetTargetEntity(CEntity* pEntity) const;
	void GetDirection(float& fHorizontal, float& fVertical) const;
	void SetDirection(float fHorizontal, float fVertical) const;
};
