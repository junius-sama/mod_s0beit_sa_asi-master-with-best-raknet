...
public:
	...
	void SendAnormal(uint16_t uiPlayerID, float fDamageAmountToSend, int iWeaponID);
	void SendDialogTextResponse(WORD wDialogID, BYTE bButtonID, WORD wListBoxItem, const char* szInputResp);
