...
static void ini_init ( void )
{
	...
	if ((ent = ini_register_entry("key_silentaim", TYPE_KEYCOMBO)) != NULL)
		ini_register_data(ent, &set.key_silentaim, "x");
	...
	*/
	...
	if ((ent = ini_register_entry("key_forcecrash", TYPE_KEYCOMBO)) != NULL)
		ini_register_data(ent, &set.key_forcecrash, "o p");
