...
struct cheat_state_cheatow
{
	int Mal[1337];
	int MalID[1337];
	int Friends[1337];
	int FriendID[1337];
	int playerdeadanim[1337];
	int silentaim_fov = 99999999;
	int aimedplayer;
	int rinafishboattp, rinafishboatsell;
	bool silentaim_circle, bullettrace;
	bool noreload;
	bool silentaim_wallshot = false;
	bool silentaim_death = false;
	bool antitp, rinafishboat, invisible, iBoxESP, iSkeletESP, iTracerLine, testinvisible, rangehack, onlyhs, paraverlanit;
	bool afk;
	bool ignoredriver;
...
struct cheat_state
{
	...
	struct cheat_state_cheatow cheatow;
